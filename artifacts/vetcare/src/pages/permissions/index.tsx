...
const MODULES = [
  ...
  { id: "owners", label: "PropriÃ©taires", icon: "ğŸ‘¤" },
  { id: "consultations", label: "Consultations", icon: "ğŸ©º" },
  { id: "factures", label: "Facturation", icon: "ğŸ’¶" },
  { id: "ordonnances", label: "Ordonnances", icon: "ğŸ“‹" },
  { id: "stocks", label: "Stocks", icon: "ğŸ“¦" t°(€ì¥è€‰ÍµÌˆ°±…‰•°è€‰M5Lˆ°¥½¸è€‹Â~NÄˆô°(€ì¥è€‰É…ÁÁ½ÉÑÌˆ°±…‰•°è€‰I…ÁÁ½ÉÑÌˆ°¥½¸è€‹Â~N(ˆô°(€ì¥è€‰Á•Éµ¥ÍÍ¥½¹Ìˆ°±…‰•°è€‰A•Éµ¥ÍÍ¥½¹Ìˆ°¥½¸è€‹Â~R@ˆô°)tì()½¹ÍĞI=1}AIMQLèI•½ÉñÍÑÉ¥¹œ°I•½ÉñÍÑÉ¥¹œ°ì…¹I•…è‰½½±•…¸ì…¹]É¥Ñ”è‰½½±•…¸ì…¹•±•Ñ”è‰½½±•…¸ôøø€ôì(€Ù•Ñ¼è=‰©•Ğ¹™É½µ¹ÑÉ¥•Ì¡5=U1L¹µ…À¡´€ôøm´¹¥°ì…¹I•…èÑÉÕ”°…¹]É¥Ñ”èÑÉÕ”°…¹•±•Ñ”è´¹¥€„ôô€‰Á•Éµ¥ÍÍ¥½¹Ìˆõt¤¤°(€…Í„è=‰©•Ğ¹™É½µ¹ÑÉ¥•Ì¡5=U1L¹™¥±Ñ•È¡´€ôø€…l‰É…ÁÁ½ÉÑÌˆ°€‰Á•Éµ¥ÍÍ¥½¹Ì‰t¹¥¹±Õ‘•Ì¡´¹¥¤¤¹µ…À¡´€ôøm´¹¥°ì…¹I•…èÑÉÕ”°…¹]É¥Ñ”èl‰…•¹‘„ˆ°€‰Á…Ñ¥•¹ÑÌˆ°€‰½İ¹•ÉÌ‰t¹¥¹±Õ‘•Ì¡´¹¥¤°…¹•±•Ñ”è™…±Í”õt¤¤°(€ÍÑ…¥…¥É”è=‰©•Ğ¹™É½µ¹ÑÉ¥•Ì¡5=U1L¹µ…À¡´€ôøm´¹¥°ì…¹I•…èl‰…•¹‘„ˆ°€‰Á…Ñ¥•¹ÑÌˆ°€‰½İ¹”rs"].includes(m.id), canWrite: false, canDelete: false }])),
};
...
export default function PermissionsPage() {
  ...
  const togglePerm = (module: string, field: "canRead" | "canWrite" | "canDelete") => {
    ...
    // Si on dÃ©coche canRead, on dÃ©coche aussi les autres
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Configurez les permissions d'accÃ¨s par module pour chaque membre de la clinique</p>
      </div>
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-4 py-3 border-b border-gray-100 bg-gray-50">
              <h2 className="text-sm font-semibold text-gray-700">Ã‰quipe</h2>
            </div>
            {usersLoading ? (
              ...
              <div className="p-6 text-sm text-gray-400 text-center">Aucun utilisateur trouvÃ©</div>
            ) : (
        ...
        <div className="col-span-2">
          {!selectedUser ? (
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-12 text-center text-gray-400">
              ...
              <p className="font-medium">SÃ©lectionnez un utilisateur</p>
              <p className="text-sm mt-1">pour gÃ©rer ses permissions</p>
            </div>
          ) : (
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <span className="text-xs text-gray-500 self-center">PrÃ©rÃ©glages :</span>
                  {[
                    { key: "veto", label: "VÃ©tÃ©rinaire" },
                    { key: "asa", label: "ASA" },
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      ...
                      <th className="text-center px-4 py-3 font-semibold text-gray-600">Ã‰criture</th>
                        ...
                        <tr key={m.id} className={`hover:bg-gray-50 transition-colors ${isDirty ? "bg-yellow-50" : ""}`}>
                          <td className="px-5 py-3">
                            <div className="flex items-center gap-2">
                              ...
                              {isDirty && <span className="w-1.5 h-1.5 rounded-full bg-yellow-400" title="ModifiÃ©" />}
                            </div>
                          </td>
              ...
              <div className="px-5 py-4 border-t border-gray-100 flex justify-between items-center">
                {saveSuccess ? (
                  <span className="text-sm text-green-600 font-medium flex items-center gap-1">
                    ...
                    Permissions enregistrÃ©es
                  </span>
                ) : (
                  <span className="text-xs text-gray-400">
                    {Object.keys(localPerms).length > 0
                      ? `${Object.keys(localPerms).length} module(s) modifiÃ©(s) â€” non enregistrÃ©`
          ...
          <div className="mt-4 flex gap-6 text-xs text-gray-500">
            ...
            <div className="flex items-center gap-1.5">
              ...
              Ã‰criture : peut crÃ©er/modifier
            </div>
            <div className="flex items-center gap-1.5">
