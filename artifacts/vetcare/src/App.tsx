      ...
      <Switch>
        ...
        <AppLayout>
          <Switch>
            ...
            <Route path="/patients/nouveau">{() => <PrivateRoute component={NouveauPatientPage} />}</Route>
            ...
            <Route path="/consultations/nouvelle">{() => <PrivateRoute component={NouvelleConsultationPage} />}</Route>
